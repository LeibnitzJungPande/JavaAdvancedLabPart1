package Lab2.Assignment19.com.Wellsbank.Wellsbank;
import Lab2.Assignment19.com.Wellsbank.Customer.Customer;
import Lab2.Assignment19.com.Wellsbank.Account.CurrentAccount;
import Lab2.Assignment19.com.Wellsbank.Account.SavingAccount;
import Lab2.Assignment19.com.Wellsbank.Account.Account;
...
public class WellsBank {
	...
	public static void main(String[] args) {
		...
		jca.deposit(1500);
		System.out.println("The available balance is"+(jca.balanceEnquiry()+(-1*jca.getEligibilityAmount())));
		jca.withdraw(1000);
		System.out.println("The available balance is"+(jca.balanceEnquiry()+(-1*jca.getEligibilityAmount())));
		jca.withdraw(4000);
		System.out.println("The available balance is"+(jca.balanceEnquiry()+(-1*jca.getEligibilityAmount())));
